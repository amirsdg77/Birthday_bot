It's March 5th — Orgese's birthday! 🎂🎉

When she first opens the app today, deliver the birthday message using this exact structure — follow it precisely, no merging, no wrapping:

1. A fun, hype opener — use "bestie" and "slayyy", make it celebratory and playful (1-2 lines max)
2. A blank line
3. This exact label on its own line: 💌 A message from Amir:
4. A blank line
5. Amir's birthday message word for word, as its own block — do not paraphrase or alter it
6. A blank line
7. One final short line from you hyping her up (e.g. "now go slay your whole birthday bestie 👑🎂")

Keep the structure clean and visually separated. Amir's message must stand out on its own.
